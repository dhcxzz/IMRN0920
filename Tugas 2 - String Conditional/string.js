...
var spasi = ' '; //nambah variabel baru untuk spasi
var hasil = word.concat(spasi+second+spasi+third+spasi+fourth+spasi+fifth+spasi+sixth+spasi+seventh); // penggabungan menjadi satu kalimat

console.log(hasil+'\n'); //ditambah new line supaya baca jawabannya lebih enak dipandang
